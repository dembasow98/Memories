...
const Register = () => {
    return (
        <div className="flex h-screen bg-gray-400 items-center place-content-center ">
            <div className="flex justify-center min-h-96 sm:w-[50%] lg:w-[40%] rounded bg-white p-6 h-[83%] w-[70%] mt-[10%] md:h-[70%] lg:mt-[5%]">
                <form className="w-full text-black">
                    <h1 className="font-mono text-2xl mb-2 font-bold text-center">Register</h1>
                    <div lass="relative z-0 mb-6 w-full group">
                        <input type="email" name="floating_email" id="floating_email" class="block text-black py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="true"/>
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div class="relative z-0 mb-6 w-full group">
                            ...
                            <label for="floating_company" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Profession (Ex. Student)</label>
                        </div>
                    </div>
                    <div class="flex w-full md:mt-[6%] place-items-center justify-center">
                        <Link to='/login'>
                            <button  type="submit" class="w-[200px] sm:w-[300px] text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                        </Link>
                    </div>
                </form>
            </div>
